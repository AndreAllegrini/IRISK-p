...
Pfact ~ 0*",PRSname,"_Child + 0*",PRSname,"_Mother + 0*",PRSname,"_Father
...
Pfact ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
mfq + anx + cnd + odd + hyp + inat  ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
Pfact =~ mfq + anx + cnd + odd + hyp + inat
 ...
 anx + cnd + odd + hyp + inat  ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father

mfq68+mfq69+mfq70+mfq71+mfq72+mfq73+mfq74+mfq75+mfq76+mfq77+mfq78+mfq79+mfq80 ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
mfq + cnd + odd + hyp + inat  ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father

anx145+anx146+anx147+anx148+anx149 ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
mfq + anx + odd + hyp + inat  ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father

cnd111+cnd112+cnd113+cnd114+cnd115+cnd116+cnd117+cnd118 ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
mfq + anx + cnd + hyp + inat  ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father

 odd137+odd138+odd139+odd140+odd141+odd142+odd143+odd144 ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
mfq + anx + cnd + odd + inat  ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father

hyp128+hyp129+hyp130+hyp131+hyp132+hyp133+hyp134+hyp135+hyp136 ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
mfq + anx + cnd + odd + hyp  ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father

inat119+inat120+inat121+inat122+inat123+inat124+inat125+inat126+inat127 ~ ",PRSname,"_Child + ",PRSname,"_Mother + ",PRSname,"_Father
...
# save fit
saveRDS(fit, file = paste0("../output/",PRSname,"_",MODEL,"_trio.rds"))
